...
module.exports = {
  ...
  rules: {
    ...
    'no-debugger': process.env.NODE_ENV === 'production'
      ? 'error'
      : 'off',
    // "no-const-assign": "warn", "no-this-before-super": "warn", "no-undef":
    // "warn", "no-unreachable": "warn", "no-unused-vars": "warn",
    // "constructor-super": "warn", "valid-typeof": "warn", "indent": ["error", 4],
    "semi": 0,
    "quotes": 0
  }
}
