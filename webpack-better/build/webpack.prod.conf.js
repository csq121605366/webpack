...
const webpackConfig = merge(baseWebpackConfig, {
  ...
  plugins: [
    ...
    // dll的引用
    new webpack.DllReferencePlugin({manifest: require('../src/dll/ui-manifest.json')}),
    new webpack.DllReferencePlugin({manifest: require('../src/dll/vue-manifest.json')}),
    ...
    new ExtractTextPlugin({
      ...
      // because we are seeing that sourcemaps are included in the codesplit bundle as
      // well when it's `false`, increasing file size:
